...
# Enhanced Training Function with Model Saving
def train_enhanced_model(model_name="efficientnet_b0", batch_size=32, max_epochs=100):
    ...
    final_model_path = os.path.join(save_dir, f"{model_name}_final.ckpt")
    ...
    comparison_df = pd.DataFrame([
        {
            ...
            'Final Model Path': r['final_model_path']
        }
...
if __name__ == "__main__":
    ...
    if len(metrics_df) > 0:
        ...
        print(f"  Final Model Path: {best_model['final_model_path']}")