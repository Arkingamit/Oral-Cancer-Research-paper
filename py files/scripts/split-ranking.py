...
train_data.to_csv('./datasets/triplet/train.csv', index=False)
valid_data.to_csv('./datasets/triplet/val.csv', index=False)
test_data.to_csv('./datasets/triplet/test.csv', index=False)
print("OK!")
