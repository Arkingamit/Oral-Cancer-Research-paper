...
class TripletDataset(torch.utils.data.Dataset):
    def __init__(self, dataset, features, ranking, img_dataset):
        ...
        # Load triplets and sanitize column names
        ...
        # Filter triplets to keep only those whose IDs exist in the feature dataset
        valid_ids = set(features_dataset["image_id"])
        ...
        # Step 1: Extract all unique image IDs used in triplets
        triplets_ids = set(
        ...
        # Step 2: Get image file names from ranking.csv
